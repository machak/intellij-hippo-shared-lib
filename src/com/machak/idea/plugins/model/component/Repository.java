...
/**
 * Defines a Maven repository to be included in the assembly. The artifacts available to be included in a repository are
 * your project's dependency artifacts. The repository created contains the needed metadata entries and also contains
 * both sha1 and md5 checksums. This is useful for creating archives which will be deployed to internal repositories.
 * <p>
 * <br/><b>NOTE:</b> Currently, only artifacts from the central repository are allowed.
 * <p>
 * <p>
 * <p>
 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="groupVersionAlignment" type="{http://maven.apache.org/plugins/maven-assembly-plugin/component/1.1.2}GroupVersionAlignment"
...
@XmlType(name = "Repository", namespace = "http://maven.apache.org/plugins/maven-assembly-plugin/component/1.1.2", propOrder = {
...
public class Repository {
    ...
    @XmlElement(namespace = "http://maven.apache.org/plugins/maven-assembly-plugin/component/1.1.2", defaultValue = "runtime")
     ...
     *
     * @return possible object is {@link Repository.Includes }
     */
     ...
     *
     * @param value allowed object is {@link Repository.Includes }
     */
     ...
     *
     * @return possible object is {@link Repository.Excludes }
     */
     ...
     *
     * @param value allowed object is {@link Repository.Excludes }
     */
     ...
     *
     * @return possible object is {@link Repository.GroupVersionAlignments }
     */
     ...
     *
     * @param value allowed object is {@link Repository.GroupVersionAlignments }
     */
